...
class oneXAPITest(unittest.TestCase):
    def test_OneXAPI_getInfo_1(self):
        ...
        res = OneXAPI.getInfo()
        answer = json.loads('{"success":true,"requestedApiCount":0,"data":{"supportedExchanges":[{"exchange":"Binance","instrument":"Spot"},{"exchange":"Binance","instrument":"Futures"},{"exchange":"Upbit","instrument":"Spot"}],"onexapiVersion":"0.0.0"}}')
